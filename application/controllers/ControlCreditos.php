<?php
class ControlCreditos extends CI_Controller
{
        ...
        {
                $data['controlCreditos'] = $this->controlCreditos_model->get_controlCreditos();
                $data['title'] = 'Clientes';

                $this->load->view('templates/header', $data);
                $this->load->view('controlCreditos/index', $data);
                $this->load->view('templates/footer');
        }
        //metodos
        public function view($id_cliente = NULL)
        {
                $data['cliente'] = $this->controlCreditos_model->get_cliente($id_cliente);
                ...
                $this->load->view('templates/header', $data);
                $this->load->view('controlCreditos/view', $data);
                $this->load->view('templates/footer');
        }
        //metodos
        public function create()
        {
                ...
                if ($this->form_validation->run() === FALSE) {
                        $this->load->view('templates/header', $data);
                        $this->load->view('controlCreditos/create',$data);
                        $this->load->view('templates/footer');
                } else {
        ...
        public function edit($id_cliente = NULL)
        {
                ...
                if ($this->form_validation->run() === FALSE) {
                        ...
                        $this->load->view('templates/header', $data);
                        $this->load->view('controlCreditos/edit', $data);
                        $this->load->view('templates/footer');
        ...
        public function update() //metodos 
        {
                ...
                echo $this->controlCreditos_model->update_cliente();
                // $this->load->view('controlCreditos/success');
                redirect('/controlCreditos/index/');
        }
        ...
        public function delete($id) //metodos
        {
                ...
                echo $this->controlCreditos_model->delete_cliente($id);
