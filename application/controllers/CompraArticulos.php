<?php
class CompraArticulos extends CI_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('compraArticulos_model');
    ...
    {
        //este nombre entre '' tiene que estar igual a como esta en la vista
        $data['compraArticulos'] = $this->compraArticulos_model->get_compraArticulos();
        $data['title'] = 'Clientes';

        $this->load->view('templates/header', $data);
        $this->load->view('compraArticulos/index', $data);
        $this->load->view('templates/footer');
    }
    //metodos
    public function view($id_cliente = NULL)
    {
        $data['cliente'] = $this->compraArticulos_model->get_cliente($id_cliente);
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('compraArticulos/view', $data);
        $this->load->view('templates/footer');
    }
    //metodos
    public function create()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('templates/header', $data);
            $this->load->view('compraArticulos/create', $data);
            $this->load->view('templates/footer');
        } else {
            $this->controlCreditos_model->set_cliente();
            $this->load->view('compraArticulos/success');
            redirect('/compraArticulos/index/');
        }
    }
    ...
    public function edit($id_cliente = NULL)
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->load->view('templates/header', $data);
            $this->load->view('compraArticulos/edit', $data);
            $this->load->view('templates/footer');
    ...
    public function update() //metodos 
    {
        ...
        echo $this->compraArticulos_model->update_cliente();
    ...
    public function delete($id) //metodos
    {
        ...
        echo $this->compraArticulos_model->delete_cliente($id);
